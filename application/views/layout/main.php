...
<!-- progress_bar -->
<link type="text/css" rel="stylesheet" href="<?php echo base_url('assets/progress_bar/style.css'); ?>" />
...
<!--<script type="text/javascript" src="<?php //echo base_url('assets/chosen/js/jquery-3.2.1.min.js'); ?>"></script>-->
...
<!-- progress_bar-->
<script type="text/javascript" src="<?php echo base_url('assets/progress_bar/jq.progress-bar.js'); ?>"></script>
